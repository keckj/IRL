...
template <typename T> class CPUResourceType,
template <typename T> class GPUResourceType>
VoxelGridTree<T,CPUResourceType,GPUResourceType> PowerOfTwoVoxelGrid<T,CPUResourceType,GPUResourceType>::splitGridWithMaxMemory(unsigned long maxMemoryPerSubgrid) {
